...
git clone https://github.com/Darkpwd/Api\_TASK.git
...
MONGO\_URI=mongodb://localhost:27017/task-manager

JWT\_SECRET=your\_jwt\_secret

Replace your\_jwt\_secret with a strong secret key for JWT signing.
...
curl -X POST http://localhost:3000/api/v1/tasks -H "Authorization: Bearer JWT\_TOKEN" -H "Content-Type: application/json" -d '{"title": "Finish homework", "description": "Complete all assignments", "priority": "high"}'
...
curl http://localhost:3000/api/v1/tasks -H "Authorization: Bearer JWT\_TOKEN"
